...
import { CSpecialty } from './models/specialty';
...
export class SpecialtyComponent implements OnInit {
  ...
  form: CSpecialty = new CSpecialty
  ...
  delete(id: string) {
    ...
    if (id === this.user._id) {
      ...
      this.subs.add(
        this.specialtyService.delete(id).subscribe((response: IResponseApi) => {
  ...
  save() {
    ...
    if (!this.validateForm()) {
      this.subs.add(
        this.specialtyService.save(this.form).subscribe((response: IResponseApi) => {
