...
import { Company } from './../../modules/admin/companies/models/company';
...
// COMPANIES
export const setCompanyData = createAction('setCompanyData', props<{ dataCompany: Company }>())
export const editCompany = createAction('editCompany', props<{ company: Company }>())
