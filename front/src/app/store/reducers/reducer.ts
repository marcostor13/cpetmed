...
const reducer = createReducer(
    ...
    on(
        states.setCompanyData,
        (state: globalState.IStoreState, action: { dataCompany: Company }): globalState.IStoreState => {
            return {
                ...state,
                company: action.dataCompany
            }
        }
    ), 
    ...
    on(
        states.editCompany,
        (state: globalState.IStoreState, action: { company: Company }): globalState.IStoreState => {
            const newCompany = { ...action.company, elementSelected: null, elementSelectedIndex: null }
            return {
                ...state,
                company: newCompany,
            }
